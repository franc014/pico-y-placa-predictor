import { validatePlate, validateDate, validateTime } from "../src/validator";
describe("Predictor input validations", () => {
  it("validates a car plate", () => {
    const plate1 = "P768-345";
    const plate2 = "G768-3496";

    const plate1IsValid = validatePlate(plate1);
    const plate2IsValid = validatePlate(plate2);
  ...
  it("invalidates a car plate", () => {
    ...
    const plate1IsValid = validatePlate(plate1);
    const plate2IsValid = validatePlate(plate2);
    const plate3IsValid = validatePlate(plate3);
  ...
  it("validates date format", () => {
    ...
    const date1IsValid = validateDate(date1);
    const date2IsValid = validateDate(date2);
